...
export default ({show, setShow, user, service}) => {
    ...
    const handleFinishClick = async () => {
        if( user.id && service !== null && selectedYear > 0 && selectedDay > 0 && selectedHour !== null){
                            ...
                            {listDays.map((item, key)=>(
                                <DateItem 
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: item.number === selectedDay ? '#4EADBE' : 'white',
                                    }}
                                >
                                    <DateItemWeekDay
                                        style={{
                            ...
                            <TimeList horizontal showsHorizontalScrollIndicator={false}>
                                {listHours.map((item, key)=>(
                                    <TimeItem
                                        ...
                                        style={{
                                            backgroundColor: item === selectedHour ? '#4EADBE' : 'white',
                                        }}
                                    >
                                        <TimeItemText
                                            style={{
